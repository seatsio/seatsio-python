...
class ChartObjectInfo:
    def __init__(self, item_data):
        ...
        self.area_type = item_data.get("areaType")
        ...
        self.has_lift_up_armrests = item_data.get("hasLiftUpArmrests")
        self.is_hearing_impaired = item_data.get("isHearingImpaired")
        self.is_semi_ambulatory_seat = item_data.get("isSemiAmbulatorySeat")
        self.has_sign_language_interpretation = item_data.get("hasSignLanguageInterpretation")
        self.is_plus_size = item_data.get("isPlusSize")
...
class Workspace:
    ...
    def __init__(self, data):
        ...
        self.secret_keys = data.get("secretKeys")
