class StatusChangeRequest:
    ...
    def __init__(self, event_key, object_or_objects, status=None, hold_token=None, order_id=None, keep_extra_data=None, ignore_channels=None, channel_keys=None, allowed_previous_statuses=None, rejected_previous_statuses=None, type=None, resale_listing_id=None, season=None):
            self.type = type
