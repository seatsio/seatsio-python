...
class ChannelsClient:
    ...
    def add(self, event_key, channel_key, channel_name, channel_color, index=None, objects=None, area_places=None):
        self.http_client \
            .url('/events/{key}/channels', key=event_key) \
            .post(AddChannelRequest(channel_key, channel_name, channel_color, index, objects, area_places))
    ...
    def update(self, event_key, channel_key, name=None, color=None, objects=None, area_places=None):
        self.http_client \
            .url("/events/{event_key}/channels/{channel_key}", event_key=event_key, channel_key=channel_key) \
            .post(UpdateChannelRequest(name, color, objects, area_places))

    def add_objects(self, event_key, channel_key, objects=None, area_places=None):
        self.http_client \
            .url("/events/{event_key}/channels/{channel_key}/objects", event_key=event_key, channel_key=channel_key) \
            .post(EditObjectsForChannelRequest(objects, area_places))

    def remove_objects(self, event_key, channel_key, objects=None, area_places=None):
        self.http_client \
            .url("/events/{event_key}/channels/{channel_key}/objects", event_key=event_key, channel_key=channel_key) \
            .delete(EditObjectsForChannelRequest(objects, area_places))
