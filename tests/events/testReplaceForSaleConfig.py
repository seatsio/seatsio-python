...
class ReplaceForSaleConfigTest(SeatsioClientTest):

    def test_objects_and_categories(self):
        chart_key = self.create_test_chart()
        event = self.client.events.create(chart_key)

        self.client.events.replace_for_sale_config(event.key, False, ["o1", "o2"], {"GA1": 3}, ["cat1", "cat2"])
    ...
    def test_objects(self):
        ...
        self.client.events.replace_for_sale_config(event.key, False, objects=["o1", "o2"])
    ...
    def test_categories(self):
        ...
        self.client.events.replace_for_sale_config(event.key, False, categories=["cat1", "cat2"])
    ...
    def test_num_not_for_sale_is_correctly_exposed(self):
        ...
        self.client.events.replace_for_sale_config(event.key, False, [], {"GA1": 3}, [])
    ...
    def for_sale(self):
        ...
        self.client.events.replace_for_sale_config(event.key, True, ["o1", "o2"], {"GA1": 3}, ["cat1", "cat2"])
